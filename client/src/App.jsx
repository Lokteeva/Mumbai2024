 ...
 <div className='banner2'>
    ...
    <h5 className='banner1 h5'>      
      Паломничество в Индию с <span className='textOrange'> Бхата Бхгатамрита Кешава Свами</span><br/>
                      ...
                      2 недели паломнического путешествия в <span className='textOrange'>Чарупати, Бомбей , Нешик , Джуху</span>
...
<div></div>                 
  ...
  <div></div>
  <button className="btn2" >Заявка</button>
  <div></div>
</div> 
...
<div >
  ...
  <img src="/swami.jpg" alt="img"/>
       ...
       <div className="lisection">
        <h2 className=''>Вам <span >НУЖНО</span> особенное время :</h2>
         <div className='center-div'>
         <ul>
            <li>Погрузится в духовный мир</li>
            <li>Наполниться силой</li>
            <li>Получить даршан Гуру</li>
            <li>Отдохнуть  в атмосфере благости</li>
            <li>Провести время с семьей</li>
          </ul>
         </div>
